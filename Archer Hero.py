...
game.over = False
start.moveTo(start.x,start.y+350)

while not game.over:
    game.processInput()
    bk.draw()
    
    game.drawText("You are a magical archer! You have been injured in a war.",200,100,f)
    game.drawText("The rest of your army abandond you and retreated without",200,125,f)
    game.drawText("you. You wake up after passing out from the injury you were",200,150,f)
    game.drawText("given throughout the war. Now that your wounds are healed",200,175,f)
    game.drawText("The enemy has noticed you and are sending small groups of",200,200,f)
    game.drawText("their forces in your direction. You must survive as long as",200,225,f)
    game.drawText("you can until your army notices you,and rescues you",200,250,f)
    start.draw()
